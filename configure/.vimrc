...
if MyOS() == "windows"
    ...
    cno $m1 e D:/www/marketbright/dev/trunk/<CR>
    cno $m2 e D:/www/marketbright/vtwo/trunk/<CR>
    cno $y e D:/www/youtochina/<CR>
elseif MyOS() == "linux"
    cno $w e /media/Workspace/www/<CR>
    cno $m e /media/Workspace/www/marketbright/<CR>
    cno $m1 e /media/Workspace/www/marketbright/DEV/trunk/<CR>
    cno $m2 e /media/Workspace/www/marketbright/VTWO/trunk/<CR>
...
" general abbrevs
""""""""""""""""""""""""""""""""""""
iab xdate <C-R>=strftime("%d/%m/%d %H:%M:%S")<CR>
...
"let g:noecomplcache_enable_auto_select=0
...
"The snippet files user defined
